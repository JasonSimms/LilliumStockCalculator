...
console.log(`Lillium.js`.america.bold)
console.log(`
...
Since API source is free to use I have included my key in config.js for your comfort. 
Just press X as suggested below!
...
rl.question("Enter a valid stock symbol: ".green, arg1 => {
  rl.question("Enter a Start Date as YYYY-MM-DD: ".green, arg2 => {
    rl.question("Enter a End Date as YYYY-MM-DD: ".green, arg3 => {
      rl.question(
      ...
      `.green,
        arg4 => {
          if (arg4.toLowerCase() === "x") {
            ...
            else console.log(`Insert your api key in the config file`.black.bgRed)
          }
          if (!arg4 || !arg1) {
            console.log("Input incomplete! Please restart the program.".black.bgRed);
          } else if (!dateValidation(arg2) || !dateValidation(arg3)) {
            console.log("Date input invalid! Please restart the program.".black.bgRed);
          } else {
